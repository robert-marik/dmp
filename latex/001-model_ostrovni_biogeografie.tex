...
\begin{itemize}
\item Počet druhů, které za jednotku času proniknou na ostrov a úspěšně se zde zabydlí, roste s počtem
...
\begin{itemize}
\item Některé druhy v minulosti již úspěšně
kolonizovaly ostrov, ale neobstály v~ konkurenci 
pozdějších kolonizátorů a na ostrově vymřely.
\item Rychlost vymírání, tj. počet druhů, které za jednotku času na ostrově vymřou,
roste s~ klesající rozlohou ostrova a s rostoucím počtem druhů na
ostrově (ostrov menší rozlohy má menší nosnou
kapacitu a mezi mnoha druhy je více kandidátů na vyhynutí).
...
Derivace $\frac{\mathrm dN}{\mathrm dt}$ je rychlost růstu počtu druhů, tj. nárůst za 
jednotku času.
Tento nárůst je rozdílem rychlosti kolonizace a rychlosti
vymírání.
...
Model vysvětluje souvislost velikosti a polohy 
lokality s počtem druhů, které danou lokalitu 
trvale obývají.
