...
Jako ukázku si představíme model ochlazování, například kávy. Jedná se však o univerzální přístup a později uvidíme, že stejný model popisuje i procesy probíhající v přírodě a ekosystémech.

*Foto: Derivace jsou základním nástrojem pro modelování systémů s deterministickým chováním. Jedny z nejjednodušeji modelovatelných procesů jsou radioaktivní rozpad a ochlazování kávy. My se budeme zabývat druhým z nich. Autor: JillWellington, <https://pixabay.com>*
```
