...
*Foto: Derivace jsou základním nástrojem pro modelování systémů s deterministickým chováním. Jedny z nejjednodušeji modelovatelných procesů jsou radioaktivní rozpad a ochlazování kávy. My se budeme zabývat druhým z nich. Autor: JillWellington, pixabay.com*
```
