...
data = [
    np.arange(1910,1924),
    [5.7, 8.8, 9.5, 15.7, 14.6, 7.6, 16.2, 15.4, None, 19.9, 15.8, 13.3, 10.7, 10.2],
    [None, None, None, None, 11.9, 21.4, 22.1, 21.2, 36.4, 27.3, 16.0, 15.9, 14.8, 10.7],
    [21.8, None, None, None, None, None, None, None, None, 30.9, 25.3, 25.9, 25.8, 26.6]
    ]
df = pd.DataFrame(np.array(data).T, columns=(["Rok","Terst","Rijeka","Benátky"]))
