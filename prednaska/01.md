...
*Foto: Keith Williams, commons.wikimedia.org*
```
...
s konečnou nosnou kapacitou. Jednoduchým matematickým modelem rychlosti takového růstu je
funkce 
$$
f(x)=rx\left(1-\frac xK\right),
$$
kde $K$ je _nosná kapacita prostředí_ a $r$ je _invazní parametr_ (specifická
rychlost růstu pro malé velkosti populace). Tato kvadratická funkce proměnné $x$
