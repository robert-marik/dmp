...
parametry i ona sledovaná veličina, což vede na diferenciální rovnice. Nyní si
...
Shrňme si nejprve základní fyzikální představy.
...
\varrho c \frac{\partial T}{\partial t}=\frac{\partial }{\partial x}
